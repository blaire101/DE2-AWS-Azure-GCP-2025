...
| Layer         | Azure                                 | AWS                                | GCP                               | Traditional            |
|---------------|---------------------------------------|------------------------------------|-----------------------------------|------------------------|
| Data Lake     | Azure Data Lake Storage (ADLS)        | Amazon S3                          | Google Cloud Storage (GCS)        | HDFS (cloudified)      |
| Data Warehouse| Azure Synapse Analytics               | Amazon Redshift                    | BigQuery                          | Hive / Impala (DW)     |
| Batch ETL     | Azure Data Factory / HDInsight        | AWS Glue / EMR                     | Dataflow / Dataproc               | Spark                  |
| Streaming ETL | Event Hubs / Stream Analytics         | Kinesis / MSK / KDA                | Pub/Sub + Dataflow (streaming)    | Flink / Storm          |
