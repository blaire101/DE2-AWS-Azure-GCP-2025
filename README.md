...
| **Batch ETL**    | <mark>**AWS Glue Studio**</mark> → Visual pipeline design<br><mark>**AWS Glue Jobs**</mark> → Serverless Spark ETL<br><mark>**Amazon EMR**</mark> → Managed Hadoop/Spark for large-scale jobs | <mark>**Azure Data Factory (ADF)**</mark> → Orchestration & visual pipelines<br><mark>**Mapping Data Flows**</mark> → Spark-based serverless ETL<br><mark>**HDInsight / Databricks**</mark> → Managed Hadoop/Spark clusters | <mark>**Cloud Data Fusion**</mark> → Visual pipeline orchestration (CDAP-based)<br><mark>**Dataflow**</mark> → Serverless batch ETL (Apache Beam)<br><mark>**Dataproc**</mark> → Managed Hadoop/Spark clusters | <mark>**Apache Spark / Hadoop**</mark> (self-managed, on-premise) |
