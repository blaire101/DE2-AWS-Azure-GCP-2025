...
|-----------------|--------------------------|-------------|
| **Batch**       | AWS_Glue | **Fully managed ETL Service** - Crawlers automatically infer schemas; Glue ETL jobs (Spark-based) handle transformations. |
|                 | AWS_DMS | **Database Migration Service** - Supports full load and CDC (Change Data Capture) to migrate databases into **Amazon S3**, **Redshift**, or **Aurora**. |
